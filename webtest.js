...
function gotRemoteStream(event) {
  ...
  console.log("got remoteStream:", remoteStream.id)
  console.log("tracks:", remoteStream.getVideoTracks())


  // delete all old tracks
  if (remoteVideo.srcObject != null) {
    console.log("remoteVideo tracks:", remoteVideo.srcObject.getVideoTracks());
  //   console.log("Removing old tracks:", remoteVideo.srcObject.getVideoTracks().length);
  //   remoteVideo.srcObject.getVideoTracks().forEach(track => {
  //     track.stop()
  //     remoteVideo.srcObject.removeTrack(track);
  //   });
  //   remoteVideo.srcObject.addTrack(event.streams[0].getVideoTracks()[0])
  }
